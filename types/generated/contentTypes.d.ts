...
export interface ApiArtikelArtikel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    isi_artikel: Schema.Attribute.Blocks;
...
export interface ApiDestinasiDestinasi extends Struct.CollectionTypeSchema {
  collectionName: 'destinasis';
  info: {
    displayName: 'Destinasi';
    pluralName: 'destinasis';
    singularName: 'destinasi';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    galeri: Schema.Attribute.Media<
      ...
      true
    >;
    info_praktis: Schema.Attribute.Component<
...
export interface ApiProfilDesaProfilDesa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    galeri: Schema.Attribute.Media<
      ...
      true
    >;
    jumlah_dusun: Schema.Attribute.String;
    jumlah_penduduk: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::destinasi.destinasi': ApiDestinasiDestinasi;
